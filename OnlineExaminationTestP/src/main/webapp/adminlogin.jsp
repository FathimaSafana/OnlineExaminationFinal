...
@media screen and (max-width:500px){
    ...
    <body>
        <div id="logreg-forms">
        <form class="form-signin" action="adminhome.jsp" method="POST">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Administrator LogIn</h1>
            <hr/>
            <input type="email" class="form-control" placeholder="UserName" required="" autofocus="" name="Username" />
